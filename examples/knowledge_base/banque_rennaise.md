# Banque Rennaise – Guide des services bancaires
...
- **Compte Courant Classique**
  ...
  - Option de découvert : adhérer pour un forfait de 35 € ou se retirer pour refuser les opérations
  - Carte de débit Visa incluse avec paiements sans contact

- **Compte Courant Premium**
  - Frais mensuels : 15 € (gratuit avec solde moyen de 5 000 €)
  - Remboursement illimité des retraits aux distributeurs automatiques
...
- **Livret Épargne Performance**
  ...
  - Jusqu'à 6 retraits par cycle de relevé avant frais de 10 €
  - Accès en ligne 24/7

- **Compte Épargne Jeunes (12-25 ans)**
  - Aucun frais de gestion
  - Taux d'intérêt bonifié : 5 % pour les 12-17 ans, 3 % pour les 18-25 ans
...
- **Carte Visa Récompenses**
  ...
  - TAEG d'introduction : 0 % pendant 15 mois, puis variable de 17,99 % à 27,99 %
  - Frais de transfert de solde : 3 % du montant transféré
  - Assurance voyage incluse

- **Carte Visa Premier**
  - 2 % de remise en argent sur toutes les dépenses
  - 5 % de remise sur les réservations d'hôtel et de location de voiture
  - Accès aux salons d'aéroport Priority Pass
...
- **Prêt Immobilier à Taux Fixe**
  ...
  - Décisions de préapprobation généralement sous 24 heures
  - Possibilité de remboursement anticipé sans pénalités

- **Prêt Immobilier à Taux Variable**
  - Taux initial attractif avec révision annuelle
  - Possibilité de conversion en taux fixe après 5 ans
...
- **Frais de transfert de solde** : 3 % du montant transféré
- **Frais de virement international** : 0,5 % du montant (minimum 10 €, maximum 50 €)
...
- **Service clients Premium** : 01 23 45 67 92 (24/7)
- **Site web** : [www.banquerennaise.fr](http://www.banquerennaise.fr)
...
- **Chat en direct** : Support instantané via notre site web et application mobile
...
- **Responsabilité** : Investissements durables et initiatives écologiques

---

Ce guide est conçu pour vous fournir toutes les informations nécessaires sur les services de la Banque Rennaise. Pour toute question supplémentaire, veuillez contacter notre service client.
