...
export const THEME = {
  ...
  card: {
    ...
    selected:
      'border-cyan-400 bg-cyan-900/50 shadow-[0_0_20px_rgba(103,232,249,0.3)]',
  },
...
export function getProviderBadgeClasses(
  providerType: 'llm' | 'tts' | 'stt' | 'rag'
) {
  const colors = {
...
export function getProviderAccent(providerType: 'llm' | 'tts' | 'stt' | 'rag') {
  const colors = {
    llm: {
      text: THEME.accent.cyan,
      bg: THEME.accent.cyanBg,
      border: THEME.accent.cyanBorder,
    },
    tts: {
      text: THEME.accent.purple,
      bg: THEME.accent.purpleBg,
      border: THEME.accent.purpleBorder,
    },
    stt: {
      text: THEME.accent.orange,
      bg: THEME.accent.orangeBg,
      border: THEME.accent.orangeBorder,
    },
    rag: {
      text: THEME.accent.green,
      bg: THEME.accent.greenBg,
