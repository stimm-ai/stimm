                    ...
                    if self._has_extra_keys(existing_dev_agent):
                        ...
                        update_data = AgentUpdate(
                            llm_config=ProviderConfig(
                                ...
                                config=agent_data.llm_config.config
                            ),
                            tts_config=ProviderConfig(
                                provider=agent_data.tts_config.provider,
                                config=agent_data.tts_config.config
                            ),
                            stt_config=ProviderConfig(
                                provider=agent_data.stt_config.provider,
                                config=agent_data.stt_config.config
                            ),
