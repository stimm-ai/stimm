...
class SharedStreamingManager:
    ...
    async def stream_text_to_audio(self, websocket: WebSocket, text_generator: AsyncGenerator[str, None], tts_service, session_id: str) -> AsyncGenerator[bytes, None]:
        """
    ...
    async def stream_text_to_audio_no_websocket(self, text_generator: AsyncGenerator[str, None], tts_service, session_id: str) -> AsyncGenerator[bytes, None]:
        """
