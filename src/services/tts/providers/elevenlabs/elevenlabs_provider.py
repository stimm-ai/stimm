...
class ElevenLabsProvider:
    ...
    def get_field_definitions(cls) -> dict:
        ...
        return {
            ...
            "api_key": {"type": "password", "label": "API Key", "required": True, "description": "ElevenLabs API key"},
        }
                            ...
                            try:
                                ...
                                if "audio" in data:
                                    ...
                                    if audio_b64:
                                        ...
                                        logger.debug(
                                            f"Received audio chunk {chunk_count}: {chunk_size} bytes (alignment: {has_alignment}, normalizedAlignment: {has_normalized_alignment}, isFinal: {is_final})"
                                        )
