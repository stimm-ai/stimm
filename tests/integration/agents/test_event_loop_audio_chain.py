...
async def test_vad_to_stt_chain():
    ...
    event_loop = StimmEventLoop(conversation_id="test-session", output_queue=output_queue, stt_service=stt_service, chatbot_service=chatbot_service, tts_service=tts_service, vad_service=vad_service)
