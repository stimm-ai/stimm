...
class TestEnvironmentConfig:
    ...
    @patch.dict(os.environ, {"STIMM_API_URL": "http://custom-api:9000", "LIVEKIT_URL": "ws://custom-livekit:7000"})
    ...
    def test_get_environment_config_function(self):
        ...
        from environment_config import config, get_environment_config
    ...
    def test_get_service_url_function(self):
        ...
        assert stimm_url != "Unknown service: stimm"
    ...
    def test_convenience_functions(self):
        ...
        from environment_config import get_database_url, get_livekit_url, get_qdrant_url, get_redis_url, get_stimm_api_url
